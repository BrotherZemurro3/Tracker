...
class CreateRegularTrackerViewController: UIViewController {
    ...
    private let darkColors = UIColors.shared
    ...
    private func setupButtons() {
        ...
        cancelButton.backgroundColor =  UIColors.shared.viewBackgroundColor
    ...
    private func updateCreateButtonState() {
        ...
        createButton.titleLabel?.textColor = UIColors.shared.adaptiveButtonText
        createButton.backgroundColor = UIColors.shared.adaptiveButtonBackground
    }
